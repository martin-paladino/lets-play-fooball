...
class Team(models.Model):
    ...
    team_shield = models.ImageField(
        upload_to='media/team_shields/', blank=True, null=True)
...
class Player(models.Model):
    ...
    picture = models.ImageField(
        upload_to='media/players/', blank=True, null=True)
    team = models.ForeignKey(
        Team, on_delete=models.SET_NULL, blank=True, null=True, related_name='players')
